...
public:
	...
	int turnserver_process_channeldata(int transport_protocol, uint16_t channel_number, const char * buf, ssize_t buflen, socket_base * sock);
	...
	int turnserver_process_createpermission_request(int transport_protocol, socket_base * sock, StunProtocol * protocol, struct allocation_desc* desc);
	...
	int turnserver_process_connectionbind_request(int transport_protocol, socket_base * sock, StunProtocol * protocol, struct account_desc* account);
