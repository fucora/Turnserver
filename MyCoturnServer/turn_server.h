...
public:
	...
	bool dealAllocation(u16bits method, ioa_network_buffer_handle * out_io_handle, bool * resp_constructed, SOCKET_TYPE socket_type, socket_base * sock, stun_tid * currentTid, int * errorCode, const u08bits * reason, size_t * counter);
